...
export default function Navbar() {
  ...
  return(
    <nav className='md:h-full md:w-[25%] p-5 bg-[#fcfaf8]'>
      ...
      <button className='text-white !bg-gray-500 mt-5' onClick={handleLogout}>Sign Out</button>
      <div className='flex flex-col items-center mt-10 gap-1'>
        ...
        <div className='flex flex-row justify-start items-center w-full hover:bg-[#dd493f22] p-2 rounded-md hover:text-[#dd493f] cursor-pointer'>
          <div className='w-10 flex justify-center items-center'>
